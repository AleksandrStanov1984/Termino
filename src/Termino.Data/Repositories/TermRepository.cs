...
public class TermRepository:ITermRepository
{
    ...
    public Task<List<TermItem>> GetAllAsync( CancellationToken ct = default ) => _db.Terms.AsNoTracking().OrderByDescending
        ( t => t.Status == TermStatus.Pending ).ThenBy( t => t.DueAt ).ToListAsync( ct );
}